...
analyze -sv [glob ./Project1_team_H/src/original/RV12/ahb3lite_pkg/*.sv]
analyze -sv [glob ./Project1_team_H/src/original/RV12/rtl/verilog/pkg/*.sv]
analyze -sv [glob ./Project1_team_H/src/original/RV12/memory/*.sv]
analyze -sv [glob ./Project1_team_H/src/original/RV12/rtl/verilog/core/ex/*.sv]
analyze -sv [glob ./Project1_team_H/src/original/RV12/rtl/verilog/core/memory/*.sv]
analyze -sv [glob ./Project1_team_H/src/original/RV12/rtl/verilog/core/cache/*.sv]
analyze -sv [glob ./Project1_team_H/src/original/RV12/rtl/verilog/core/*.sv]
analyze -sv [glob ./Project1_team_H/src/original/RV12/rtl/verilog/ahb3lite/*.sv]
